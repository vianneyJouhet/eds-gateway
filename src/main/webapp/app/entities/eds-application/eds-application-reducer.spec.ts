...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDSAPPLICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_EDSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EDSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EDSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EDSAPPLICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EDSAPPLICATION actions', async () => {
      const expectedActions = [
        {
