...
import static fr.chu.bordeaux.eds.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static fr.chu.bordeaux.eds.test.util.OAuth2TestUtil.authenticationToken;
import static fr.chu.bordeaux.eds.test.util.OAuth2TestUtil.registerAuthenticationToken;
