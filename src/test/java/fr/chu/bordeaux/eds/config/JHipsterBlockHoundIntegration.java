...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("fr.chu.bordeaux.eds.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("fr.chu.bordeaux.eds.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
